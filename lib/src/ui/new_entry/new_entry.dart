...
import 'package:mediminder/src/common/convert_time.dart';
import 'package:mediminder/src/models/errors.dart';
import 'package:mediminder/src/models/medicine.dart';
import 'package:mediminder/src/models/medicine_type.dart';
import 'package:mediminder/src/ui/homepage/homepage.dart';
import 'package:mediminder/src/ui/new_entry/new_entry_bloc.dart';
import 'package:mediminder/src/ui/success_screen/success_screen.dart';
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: StreamBuilder<MedicineType>(
                  stream: _newEntryBloc.selectedMedicineType as Stream<MedicineType>,
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              ...
              onChanged: (newVal) {
                setState(() {
                  _selected = newVal ?? 0;
                  _newEntryBloc.updateInterval(newVal ?? 0);
                });
              },
            ),
            Text(
